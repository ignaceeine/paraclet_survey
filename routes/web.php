...
Route::post('admin/groupes/update/{id}', [GroupeController::class, 'update'])->name('groupe.update');
Route::post('admin/groupes/update/{id}', [GroupeController::class, 'updatename'])->name('groupe.update-name');
